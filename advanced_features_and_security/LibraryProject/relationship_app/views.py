...
# Security Note: All views use Django's ORM for database queries, which automatically
# parameterizes inputs to prevent SQL injection. User inputs are validated using Django forms.
...
# ✍️ Book CRUD views with custom permissions
